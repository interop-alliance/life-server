...
We received a request to reset your password for your Life Server account, ${data.webId}
...
<p>We received a request to reset your password for your Life Server account, ${data.webId}</p>
