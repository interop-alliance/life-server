...
const LegacyResourceMapper = require('../../src/storage/ldp-backend-fs/legacy-resource-mapper')
const { LdpFileStore } = require('../../src/storage/ldp-backend-fs/ldp-file-store')
