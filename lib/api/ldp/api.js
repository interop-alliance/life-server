...
async function requestFrom ({ req, target, resource, host, ldpStore, credentials }) {
  ...
  debug('Request content-type is ', bodyContentType)
...
class RequestOptions {
   ...
   */
  constructor ({ method, target, resource, headers, bodyStream, credentials, ldpStore, host }) {
  ...
  static from ({ req, target, resource, host, ldpStore, credentials = {} }) {
    ...
    return new RequestOptions({
      method, target, resource, headers, bodyStream, credentials, ldpStore, host
    })
  }
}
