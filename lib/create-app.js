...
function createApp (argv = {}) {
  ...
  initAppLocals({app, argv, ldp, mapper})
  initHeaders(app)
 ...
 * @param ldp {LDP}
 */
function initAppLocals ({app, argv, ldp, mapper}) {
  app.locals.ldp = ldp
...
function initHeaders (app) {
  ...
  app.use((req, res, next) => {
    res.set('X-Powered-By', 'Ntropy Life Server')

    res.set('Vary', 'Accept, Authorization') // Cors lib automatically adds Vary: Origin
