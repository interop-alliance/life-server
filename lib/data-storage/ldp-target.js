...
const { RDF_MIME_TYPES, ACL_SUFFIX, META_SUFFIX } = require('../constants')
...
class LdpTarget {
  ...
  get aclUrl () {
    return this.isAcl ? this.url : resolve(this.url, ACL_SUFFIX)
  }

  get metaUrl () {
    return this.isMeta ? this.url : resolve(this.url, META_SUFFIX)
  }
